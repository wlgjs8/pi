...
CKPT_BASE=/home/plaif/workspace/openpi_runs/checkpoints/${CONFIG}/depth_z50_gripabs_h24
...
for STEP in 10000 20000 30000 40000; do
  ...
  [ -f "$OUT/step${STEP}_z50_val${STEP}.json" ]   || run_eval "$STEP" "$VAL"   "z50_val${STEP}"   ""
  [ -f "$OUT/step${STEP}_z50_train${STEP}.json" ] || run_eval "$STEP" "$TRAIN" "z50_train${STEP}" "--limit 86"
done
